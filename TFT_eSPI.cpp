...
void TFT_eSPI::init(uint8_t tc)
{
  ...
  // This loads the driver specific initialisation code  <<<<<<<<<<<<<<<<<<<<< ADD NEW DRIVERS TO THE LIST HERE <<<<<<<<<<<<<<<<<<<<<<<
    ...
    #include "TFT_Drivers/SSD1963_Init.h"
     ...
     #include "TFT_Drivers/GC9B72_Init.h"
...
#elif defined (GC9B72_DRIVER)
     #include "TFT_Drivers/GC9B72_Rotation.h"
...
#if (defined (MULTI_TFT_SUPPORT) || defined (GC9A01_DRIVER)) || defined (GC9B72_DRIVER) && !defined (ILI9225_DRIVER)
  addr_row = 0xFFFF;
  addr_col = 0xFFFF;
#endif
